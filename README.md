# Run Playwright Python Tests with HyperExecute on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Playwright Python tests using HyperExecute. This sample shows how to configure Playwright + Python + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-playwright-python-sample && cd hyperexecute-playwright-python-sample
